...
<c:forEach items='<%=request.getSession().getAttribute("cart") %>' var="ca" varStatus="loop">
  ...
  ${ca.orderid}
  ${loop.index}
  <a href="<c:url value="removefromcart.action?id=${loop.index}" />">delete</a>
...
<button class="logout"  style="align:right" type="submit" name="Order Now" value="Order">Order Now</button>
